...
gf_line(Sally.Vanya$`Percent of Scored Intervals in SD...2`~Sally.Vanya$Session...1) %>% gf_line(Sally.Vanya$`Percent of Scored Intervals in S-delta...3`~Sally.Vanya$Session...1, color = 'red')
```
### Rocky & Oaky
```{r}
library(mosaic)
favstats(~Rocky.Oaky$`SD (Attention)`)
gf_line(Rocky.Oaky$`SD (Attention)`~Rocky.Oaky$Session...2) %>% gf_line(Rocky.Oaky$`S-Delta (No Attention)`~Rocky.Oaky$Session...2, color = 'red')
```
### Rosie & Carlie
```{r}
library(mosaic)
favstats(~Rosie.Carlie$`SD (Attention)`)
gf_line(Rosie.Carlie$`SD (Attention)`~Rosie.Carlie$Session...2) %>% gf_line(Rosie.Carlie$`S-Delta (No Attention)`~Rosie.Carlie$Session...2, color = 'red')
```
### Koda & Ava
```{r}
library(mosaic)
favstats(~Koda.Ava$`SD (Attention)`)
gf_line(Koda.Ava$`SD (Attention)`~Koda.Ava$Session) %>% gf_line(Koda.Ava$`S-Delta (No Attention)`~Koda.Ava$Session, color = 'red')
```
### Kodi & Kaia
```{r}
library(mosaic)
...
gf_line(Kodi.Kaia$`SD (Attention)`~Kodi.Kaia$Session...2) %>% gf_line(Kodi.Kaia$`S-Delta (No Attention)`~Kodi.Kaia$Session...2, color = 'red')
```
...
gf_line(Rocky.Oaky.Rein$`Attention Control`~Rocky.Oaky.Rein$Session) %>% gf_line(Rocky.Oaky.Rein$`Attention Test`~Rocky.Oaky.Rein$Session, color = 'red') %>% gf_line(Rocky.Oaky.Rein$Alone~Rocky.Oaky.Rein$Session, color = 'blue')
```
